...
namespace HANGMAN
{
    public class DataAdapter : BaseAdapter<PlayerScore> // The class to call to populate score data to show into the ListView
    {
        List<PlayerScore> items;
        Activity context;

        public DataAdapter(Activity context, List<PlayerScore> items)
            : base()
        {
